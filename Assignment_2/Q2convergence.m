...
title({'Convergence path','Steepest Descent with (x0,y0)=(0,0) and γk=0.9 (constant)'});
...
title({'Convergence path','Steepest Descent with (x0,y0)=(-1,-1) and γk=0.9 (constant)'});
xlabel('x', FontWeight='bold');
ylabel('y', FontWeight='bold', Rotation=0);
...
title({'Convergence path','Steepest Descent with (x0,y0)=(0,0) and γk that minimizes f(xk+γk*dk)'});
xlabel('x', FontWeight='bold');
ylabel('y', FontWeight='bold', Rotation=0);
...
title({'Convergence path','Steepest Descent with (x0,y0)=(-1,-1) and γk that minimizes f(xk+γk*dk)'});
xlabel('x', FontWeight='bold');
ylabel('y', FontWeight='bold', Rotation=0);
...
title({'Convergence path','Steepest Descent with (x0,y0)=(0,0) and γk chosen by the Armijo rule'});
xlabel('x', FontWeight='bold');
ylabel('y', FontWeight='bold', Rotation=0);
...
title({'Convergence path','Steepest Descent with (x0,y0)=(-1,-1) and γk chosen by the Armijo rule'});
xlabel('x', FontWeight='bold');
ylabel('y', FontWeight='bold', Rotation=0);
